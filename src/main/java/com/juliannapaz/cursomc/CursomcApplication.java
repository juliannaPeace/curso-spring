package com.juliannapaz.cursomc;
...
import com.juliannapaz.cursomc.domain.Pagamento;
import com.juliannapaz.cursomc.domain.PagamentoComBoleto;
import com.juliannapaz.cursomc.domain.PagamentoComCartao;
...
import com.juliannapaz.cursomc.repositories.EstadoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "01354365321", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("995168065", "787855474"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "6589874", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "78787", cli1, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("01/08/2020 18:01"), cli1, e2);
